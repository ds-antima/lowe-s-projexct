        ...
        <div className="search-bx">
          ...
          <div className="search-field">
            ...
            <button
              ...
              aria-label="Search bar icon" style={{backgroundColor:"grey"}}
...
<div className="fliter-sec">
        ...
        <div className="mobile-btns">
          <div className="button-bx">
            ...
            <a style={{backgroundColor:"#000080"}} className="btn listBtn" href="javascript:void(0);" onClick={() => {
            ...
            <div>
              ...
              {locationinbuit && locationinbuit.length <= 0 ?
               ...
               <a className="underline " href='/gb.html'>Use the search above or <span className="font-second-main-font"> browse our directory</span></a> 
                ...
                <div className="button-bx" style={{backgroundColor:"#000080"}}>
