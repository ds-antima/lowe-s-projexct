...
<Header1 _site={_site}/>
      ...
      <div className="container">
            <div style={{color:"#000080",padding:"21px"}} className="">
              <h1 style={{color:"#000080"}} className="">{name}</h1>
                <div className="openClosestatus detail-page closeing-div">
                  <OpenClose timezone={timezone} hours={hours} />
                </div> 
            </div>
          </div>
          <div style={{backgroundColor:"#f0f7fc"}}className="location-information">
        ...
        <div className="nearby-sec">
          <div className="container">
            <div  className="sec-title"><h2 style={{color:"#000080"}} className="">{StaticData.NearStoretext}</h2></div>
