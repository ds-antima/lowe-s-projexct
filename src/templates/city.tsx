...
export const config: TemplateConfig = {
  stream: {
    ...
    filter: {
      entityTypes: ["ce_city"],
      savedFilterIds: ["dm_dreamsNew-directory_address_city"],
    },
    fields: [
      "id",
      "uid",
...
export const getHeadConfig: GetHeadConfig<TemplateRenderProps> = ({
  ...
  return {
    title: `${document.c_meta_title?document.c_meta_title:`restaurant near me in ${document.name} | Find a Local Store`}`,
    charset: "UTF-8",
    ...
    tags: [
      ...
      //   // /og tags
        ...
        },
        {
          ...
          attributes: {
            ...
            content: `${document.c_meta_description?document.c_meta_description:`Find restaurant near me in ${document.name}. "We serve the both Buffet & Ala Carte. We serve Starters on Live Grill"`}`,
          },
        },
        {
          type: "meta",
...

      {
        ...
        attributes: {
          ...
          content: `${document.c_meta_description?document.c_meta_description:`Find restaurant near me ${document.name}. "We serve the both Buffet & Ala Carte. We serve Starters on Live Grill".`}`
        },
      },
    ],
  };
