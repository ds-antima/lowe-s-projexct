...
import Catogories from "../components/locationDetail/catogories";
...
export const transformProps: TransformProps<ExternalApiData> = async (
  ...
  const url = `https://liveapi-sandbox.yext.com/v2/accounts/me/entities/geosearch?radius=2500&location=${data.document.yextDisplayCoordinate.latitude},${data.document.yextDisplayCoordinate.longitude}&api_key=40ad4445b303d1cd3bfc3f0be337847e&v=20181201&resolvePlaceholders=true&entityTypes=location&limit=4`;
  console.log(url);
      ...
      >
        ...
        <AnalyticsScopeProvider name={""}>
          ...
          <div className="container">
            <div style={{ color: "#000080", padding: "21px" }} className="">
              <h1 style={{ color: "#000080" }} className="">
                {name}
              </h1>
          ...
          <Banner _site={_site} />
          <h1 style={{ marginLeft: "55px", marginTop: "22px" }}>
            About {name}
          </h1>
          ...
          <div className="nearby-sec">
            <div className="container">
              <div className="sec-title">
                <h2 style={{ color: "#000080" }} className="">
